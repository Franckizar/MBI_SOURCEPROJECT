          ...
          <div className="flex flex-col items-start space-y-6 text-left text-white">
            <div className="space-y-4">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
                About{" "}
                <span className="inline-block px-2 py-1 animate-gradient bg-gradient-to-r from-white via-purple-200 to-white bg-[length:200%_auto] text-transparent bg-clip-text">
                  MBI Digital
                </span>
              </h2>
